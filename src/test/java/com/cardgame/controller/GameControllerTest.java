...
public class GameControllerTest {
    ...
    public void testDeal() {
        ...
        Assert.isTrue(Objects.equals(response.getBody().getGame().getId().toString(), gameId), "Game ID different from sent");
        Assert.isTrue(Objects.equals(response.getBody().getPlayer().getId().toString(), playerId), "Player ID different from sent");
    }
