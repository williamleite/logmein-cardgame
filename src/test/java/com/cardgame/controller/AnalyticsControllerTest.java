...
public class AnalyticsControllerTest {
    ...
    public void testPlayersCards() {
        ...
        ResponseEntity<Card> dealResponse = restTemplate.postForEntity(dealUrl, null, Card.class);
        Card dealtCard = dealResponse.getBody();
    ...
    public void testPlayersTotal() {
        ...
        ResponseEntity<Card> dealResponse = restTemplate.postForEntity(dealUrl, null, Card.class);
        Card dealtCardPlayer1 = dealResponse.getBody();
        
        dealUrl = String.format("%s/game/deal/%s/%s", this.root(), gameId, player2Id);
        dealResponse = restTemplate.postForEntity(dealUrl, null, Card.class);
        Card dealtCardPlayer2 = dealResponse.getBody();
